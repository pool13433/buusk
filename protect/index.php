...
<html lang="en">
    <head>
        ...
        <!-- Dropzone-->
        <link type="text/css" rel="stylesheet" href="../asset/dropzone/dist/min/dropzone.min.css"/>
        <script type="text/javascript" src="../asset/dropzone/dist/min/dropzone.min.js"></script>        
        <!-- Dropzone-->
        ...
        <!-- HightChart -->
        <script src="../asset/Highcharts-4.1.4/js/highcharts.js"></script>
